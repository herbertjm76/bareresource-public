...
<head>
  ...
  <title><?= $_SESSION['site']?> | Project Profit Dashboard</title>
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="text-dark"> Project Profit Dashboard</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Financial</a></li>
              <li class="breadcrumb-item active"> Project Profit Dashboard</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
  ...
  <script src="../Inc/profit-dashboard.js"></script>
